...
std::unordered_map<std::string_view, std::unordered_map<ELanguage, std::string>> g_locale =
{
    ...
    },
    {
        "Options_Category_Input",
        {
            ...
            { ELanguage::Portuguese, "CONTROLES" }
        }
    },
    {
    ...
    },
    {
        "Options_Name_WindowSize",
        {
            ...
            { ELanguage::Portuguese, "Tamanho da janela" }
        }
    },
    {
        ...
        "Options_Desc_WindowSize",
        {
            ...
            { ELanguage::Portuguese, "Ajusta o tamanho da janela do jogo no modo janela." }
        }
    },
    {
        ...
        "Options_Desc_NotAvailable",
        {
            ...
            { ELanguage::Portuguese, "Esta opção não está disponível neste local." }
        }
    },
    {
        ...
        "Options_Desc_NotAvailableFullscreen",
        {
            ...
            { ELanguage::Portuguese, "Esta opção não está disponível no modo tela cheia." }
        }
    },
    {
        ...
        "Options_Desc_NotAvailableWindowed",
        {
            ...
            { ELanguage::Portuguese, "Esta opção não está disponível no modo janela." }
        }
    },
    {
        ...
        "Options_Desc_NotAvailableHardware",
        {
            ...
            { ELanguage::Portuguese, "Esta opção não está disponível com a configuração atual do seu hardware." }
        }
    },
    {
        ...
        "Options_Desc_NotAvailableMSAA",
        {
            ...
            { ELanguage::Portuguese, "Esta opção não está disponível sem MSAA." }
        }
    },
    {
        ...
        "Options_Desc_OSNotSupported",
        {
            ...
            { ELanguage::Portuguese, "Esta opção não é suportada pelo seu sistema operacional." }
        }
    },
    {
        ...
        "Options_Message_Restart",
        {
            ...
            { ELanguage::Portuguese, "O jogo será reiniciado agora." }
        }
    },
    {
        ...
        "Achievements_Name",
        {
            ...
            { ELanguage::Portuguese, "Conquistas" }
        }
    },
    {
    ...
    },
    {
        "Achievements_Unlock",
        {
            ...
            { ELanguage::Portuguese, "Conquista desbloqueada!" }
        }
    },
    {
        "Installer_Header_Installer",
        {
            ...
            { ELanguage::Portuguese, "INSTALADOR" },
        },
    },
    {
        "Installer_Header_Installing",
        {
            ...
            { ELanguage::Portuguese, "INSTALANDO" },
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_SelectLanguage",
        {
            ...
            { ELanguage::Portuguese, "Selecione um idioma." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_Introduction",
        {
            ...
            { ELanguage::Portuguese, "Bem-vindo ao\nUnleashed Recompiled!\n\nVocê vai precisar de uma cópia de\nSonic Unleashed de Xbox 360\npara prosseguir com a instalação." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_SelectGameAndUpdate",
        {
            ...
            { ELanguage::Portuguese, "Adicione as fontes do jogo e da sua atualização." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_SelectDLC",
        {
            ...
            { ELanguage::Portuguese, "Adicione as fontes para o DLC." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_CheckSpace",
        {
            ...
            { ELanguage::Portuguese, "O conteúdo será instalado na pasta do programa.\n\n" }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_Installing",
        {
            ...
            { ELanguage::Portuguese, "Por favor, aguarde enquanto o conteúdo é instalado..." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_InstallSucceeded",
        {
            ...
            { ELanguage::Portuguese, "Instalação concluída!\nEste projeto foi trazido até você por:" }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Page_InstallFailed",
        {
            ...
            { ELanguage::Portuguese, "A instalação falhou.\n\nErro: " }
        }
    },
    {
        "Installer_Step_Game",
    ...
    },
    {
        "Installer_Step_Update",
        {
            ...
            { ELanguage::Portuguese, "ATUALIZAÇÃO" }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Step_RequiredSpace",
        {
            ...
            { ELanguage::Portuguese, "Espaço necessário: %2.2f GiB" }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Installer_Step_AvailableSpace",
        {
            ...
            { ELanguage::Portuguese, "Espaço disponível: %2.2f GiB" }
        }
    },
    {
    ...
    },
    {
        "Installer_Button_Retry",
        {
            ...
            { ELanguage::Portuguese, "TENTAR NOVAMENTE" }
        }
    },
    {
        "Installer_Button_AddFiles",
        {
            ...
            { ELanguage::Portuguese, "ADICIONAR ARQUIVOS" }
        }
    },
    {
        "Installer_Button_AddFolder",
        {
            ...
            { ELanguage::Portuguese, "ADICIONAR PASTA" }
        }
    },
    {
        ...
        "Installer_Message_InvalidFilesList",
        {
            ...
            { ELanguage::Portuguese, "Os seguintes arquivos selecionados são inválidos:" }
        }
    },
    {
        ...
        "Installer_Message_InvalidFiles",
        {
            ...
            { ELanguage::Portuguese, "Alguns dos arquivos que foram\nfornecidos não são válidos.\n\nPor favor, verifique se todos\nos arquivos especificados estão\ncorretos e tente novamente." }
        }
    },
    {
        ...
        "Installer_Message_FilePickerTutorial",
        {
            ...
            { ELanguage::Portuguese, "Selecione um dump digital com\nconteúdo do jogo.\n\nEsses arquivos podem ser obtidos\ndo seu disco rígido de Xbox 360\nseguindo as instruções na\npágina do GitHub.\n\nPara escolher uma pasta com arquivos\nde jogo extraídos e não modificados,\nuse a opção \"Adicionar Pasta\"." }
        }
    },
    {
        ...
        "Installer_Message_FolderPickerTutorial",
        {
            ...
            { ELanguage::Portuguese, "Selecione uma pasta que contenha\nos arquivos não modificados que\nforam extraídos do jogo.\n\nEsses arquivos podem ser obtidos\ndo seu disco rígido de Xbox 360\nseguindo as instruções na\npágina do GitHub.\n\nPara escolher um dump digital,\nuse a opção \"Adicionar Arquivos\"." }
        }
    },
    {
        ...
        "Installer_Message_IncompatibleGameData",
        {
            ...
            { ELanguage::Portuguese, "O jogo especificado e a\natualização de título são incompatíveis.\n\nPor favor, verifique se os arquivos\nsão da mesma versão e\nregião e tente novamente." }
        }
    },
    {
        ...
        "Installer_Message_DLCWarning",
        {
            ...
            { ELanguage::Portuguese, "É altamente recomendado\nque você instale todo o\nDLC, pois ele inclui texturas\nde iluminação de alta\nqualidade para o jogo base.\n\nTem certeza de que deseja\npular esta etapa?" }
        }
    },
    {
        ...
        "Installer_Message_TitleMissingDLC",
        {
            ...
            { ELanguage::Portuguese, "Isso vai reiniciar o jogo para\npermitir que você instale qualquer\nDLC que esteja faltando.\n\nInstalar o DLC vai melhorar a\nqualidade da iluminação em todo o jogo.\n\nDeseja instalar o conteúdo\nfaltante?" }
        }
    },
    {
        ...
        "Installer_Message_Title",
        {
            ...
            { ELanguage::Portuguese, "Isso reinicia o jogo para\npermitir que você instale qualquer\nDLC que esteja faltando.\n\nVocê não está atualmente\nfaltando nenhum DLC.\n\nDeseja continuar\nmesmo assim?" }
        }
    },
    {
        ...
        "Installer_Message_Quit",
        {
            ...
            { ELanguage::Portuguese, "Tem certeza de que deseja sair?" }
        }
    },
    {
        ...
        "Installer_Message_Cancel",
        {
            ...
            { ELanguage::Portuguese, "Tem certeza de que deseja cancelar a instalação?" }
        }
    },
    {
    ...
    },
    {
        ...
        "Title_Message_SaveDataCorrupt",
        {
            ...
            { ELanguage::Portuguese, "O arquivo de salvamento parece estar\ncorrompido e não pode ser carregado." }
        }
    },
    {
        ...
        "Title_Message_AchievementDataCorrupt",
        {
            ...
            { ELanguage::Portuguese, "Os dados de conquistas parecem estar\ncorrompidos e não podem ser carregados.\n\nProsseguir a partir deste ponto\nirá apagar os dados de conquistas." }
        }
    },
    {
        ...
        "Title_Message_AchievementDataIOError",
        {
            ...
            { ELanguage::Portuguese, "Os dados de conquistas não puderam ser carregados.\nSuas conquistas não serão salvas." }
        }
    },
    {
        // Japanese Notes: This localization should include furigana.
        "Title_Message_UpdateAvailable",
        {
            ...
            { ELanguage::Portuguese, "Há uma atualização disponível!\n\nDeseja visitar a página de\nlançamentos para baixá-la?" }
        }
    },
    {
        "Video_BackendError",
        {
            ...
            { ELanguage::Portuguese, "Não foi possível criar um backend D3D12 (Windows) ou Vulkan.\n\nPor favor, verifique se:\n\n- Seu sistema atende aos requisitos mínimos.\n- Os drivers da sua GPU estão atualizados.\n- Seu sistema operacional está na versão mais recente disponível." }
        }
    },
    {
        "System_Win32_MissingDLLs",
        {
            ...
            { ELanguage::Portuguese, "O módulo \"%s\" não pôde ser encontrado.\n\nPor favor, verifique se:\n\n- Você extraiu esta cópia do Unleashed Recompiled por completo e não apenas o arquivo *.exe.\n- Você não está executando o Unleashed Recompiled a partir de um arquivo *.zip." }
        }
    },
    {
        "System_MemoryAllocationFailed",
        {
            ...
            { ELanguage::Portuguese, "Falha ao alocar memória do jogo.\n\nPor favor, verifique se:\n\n- Você atende aos requisitos mínimos do sistema (8 GB).\n- Seu arquivo de paginação está configurado com pelo menos 4-8 GB de memória virtual." }
        }
    },
    {
        "IntegrityCheck_Success",
        {
            ...
            { ELanguage::Portuguese, "A verificação da instalação foi concluída.\n\nTodos os arquivos parecem estar corretos.\n\nO jogo será fechado agora. Remova o argumento de inicialização para jogar." }
        }
    },
    {
        "IntegrityCheck_Failed",
        {
            ...
            { ELanguage::Portuguese, "A verificação da instalação falhou.\n\nErro: %s\n\nO jogo será fechado agora. Tente reinstalar o jogo usando o argumento de inicialização --install." }
        }
    },
    {
        "Common_On",
    ...
    },
    {
        "Common_Off",
        {
            ...
            { ELanguage::Portuguese, "DESLIGADO" }
        }
    },
    {
        "Common_Yes",
    ...
    },
    {
        "Common_Select",
        {
            ...
            { ELanguage::Portuguese, "Selecionar" }
        }
    },
    {
        "Common_Back",
    ...
    },
    {
        "Common_Reset",
        {
            ...
            { ELanguage::Portuguese, "Redefinir" }
        }
    },
    {
        "Common_Switch",
